...
export default function RegisterAndLoginForm() {
    ...
    return (
        <div className="bg-green-100 h-screen flex items-center">
            <form className="w-64 mx-auto mb-16" onSubmit={handleSubmit}>
                <input
                    value={username}
                ...
                {isLoginOrRegister === 'register' &&
                    (<div className="text-center mt-2">
                        Already a member?<button className="ml-1" onClick={() => setIsLoginOrRegister('login')}>
                            Login Here
                        </button>
                    </div>
                    )
                ...
                {isLoginOrRegister === 'login' &&
                    (<div className="text-center mt-2">
                        Dont have an account?<button className="ml-1" onClick={() => setIsLoginOrRegister('register')}>
                            Register
                        </button>
                    </div>
                    )
